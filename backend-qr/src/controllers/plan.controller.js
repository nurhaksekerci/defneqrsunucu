...
exports.seedPlans = async (req, res, next) => {
  try {
    ...
    if (existingPlans > 0) {
      return res.json({ success: true, message: 'Planlar zaten mevcut' });
    }
      ...
      data: [
        {
          ...
          features: ['1 İşletme', '5 Kategori', '20 Ürün', 'Global Katalog', 'Detaylı Grafikler'],
        },
        {
          name: 'Premium',
          type: 'PREMIUM',
          ...
          features: ['1 İşletme', 'Sınırsız Kategori', 'Sınırsız Ürün', 'Powered by kaldırma', 'Global Katalog', 'Detaylı Grafikler'],
        },
        {
          name: 'Kurumsal',
          type: 'CUSTOM',
          ...
          features: ['Çoklu İşletme', 'Sınırsız Kategori', 'Sınırsız Ürün', 'Powered by kaldırma', 'Global Katalog', 'Detaylı Grafikler'],
        },
      ],
    });

    res.json({ success: true, message: 'Default planlar oluşturuldu' });
  } catch (error) {
    next(error);
  }
};
