...
UPDATE "affiliate_settings" SET "daysPerReferralFree" = COALESCE("daysPerReferralFree", "daysPerReferral", 7), "daysPerReferralPaid" = COALESCE("daysPerReferralPaid", "daysPerReferral", 14) WHERE "daysPerReferralFree" IS NULL OR "daysPerReferralPaid" IS NULL;
